  ...
  return (
    <section id="about" className="py-20 px-6 bg-gray-800">
      ...
      <div className="max-w-4xl mx-auto text-lg leading-relaxed">
        ...
        <h3 className="text-2xl font-semibold mt-8 mb-4">Project Goals</h3>
        <ul className="list-disc pl-6">
          <li>Develop an AI-controlled boat navigating Monaco bay</li>
          <li>Integrate Unity simulation with real hardware</li>
          <li>Individual focus areas: AI, 3D camera integration, team organization</li>
          <li>Demonstrate skills in an international competition</li>
        </ul>
        
        <h3 className="text-2xl font-semibold mt-8 mb-4">Individual Topics</h3>
